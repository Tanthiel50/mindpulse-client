    ...
    >
      ...
      {isLoading ? (
        ...
        <>
          ...
          <Box component="form" onSubmit={handleSubmit} sx={{ width: "50%" }} encType="multipart/form-data">
            <TextField
              label="Titre"
              name="title"
            ...
            <Button
              variant="contained"
              component="label"
              sx={{ marginTop: "1rem", backgroundColor: "white", color: "black", fontWeight: "bold", "&:hover": { backgroundColor: "black", color: "white" } }}
            >
              Charger l'image
              <input
                type="file"
